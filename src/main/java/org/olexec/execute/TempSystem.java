...
public final class TempSystem {

    private TempSystem() {
    }

    public final static InputStream in = new TempInputStream();

    public final static PrintStream out = new TempPrintStream();
